...
def parse_args():  # need to keep this, since the writer needs 'args'
    # fmt: off
...
def linear_schedule(start_e: float, end_e: float, duration: int, t: int):  # decreasing epsilon
...
if __name__ == "__main__":
    ...
    args = parse_args() # take in arguments
    ...
    envs = gym.vector.SyncVectorEnv(
        [make_env(args.env_id, args.seed + i, i, args.capture_video, run_name) for i in range(args.num_envs)] ) # can probably be simplified
